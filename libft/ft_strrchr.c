...
/*   Updated: 2024/06/13 15:01:02 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @var count 		An unsigned integer to count the 
 * 					characters in the string.
 * @var position 	A pointer to the string `s` 
 * 					as soon as `s` is cast to a char pointer.
 * @var last 		An integer to store the last 
 ...
 * 					ft_strrchr.c ft_strlen.c libft.h
 */
