> :warning: **Important:** The use of the `MLX42` library is essential for the `so_long` project. Please ensure you have correctly set up and initialized the `MLX42` before running the project.
</br>
<div align="center">
